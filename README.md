...
<table>
	...
	<tbody>
		<tr>
			<td colspan="5"><center align="center" style="background: #2972fa; border-color: #2972fa; padding: .75rem 1.25rem; border-radius:2px; color: #fff; position: relative; margin: .5rem;">Regular Class (eg. <b>u-none</b>)</center></td>
		</tr>
		<tr>
